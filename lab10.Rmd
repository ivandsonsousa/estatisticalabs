...
Por fim, também é inressante citar uma função que utiliza o critério do p-valor para adicionar e remover preditores de um modelo até chegar a um modelo otimizado, de acordo com o critério. Conforme pode ser visto logo abaixo, a função `ols_step_both_p()` cumpre esse objetivo:
