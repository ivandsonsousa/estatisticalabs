...
# Step 2
add1(lm(runs ~ 1 + at_bats, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 3
add1(lm(runs ~ 1 + at_bats + hits, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 4
add1(lm(runs ~ 1 + at_bats + hits + homeruns, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 5
add1(lm(runs ~ 1 + at_bats + hits + homeruns + bat_avg, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 6
add1(lm(runs ~ 1 + at_bats + hits + homeruns + bat_avg + strikeouts, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 7
add1(lm(runs ~ 1 + at_bats + hits + homeruns + bat_avg + strikeouts + stolen_bases, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 8
add1(lm(runs ~ 1 + at_bats + hits + homeruns + bat_avg + strikeouts + stolen_bases - new_onbase, mlb11_runs), test = "F", scope = formula(runs_full))
# Step 9
add1(lm(runs ~ 1 + at_bats + hits + homeruns + bat_avg + strikeouts + stolen_bases - new_onbase - new_slug, mlb11_runs), test = "F", scope = formula(runs_full))
```