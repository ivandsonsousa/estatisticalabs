...
```{r}
runs_full <- lm(runs ~ at_bats, data = mlb11_runs)
summary(runs_full)
```
...
De acordo com o modelo ajustado, apenas um parâmetro é significativo no nível de 0,05, que é o corficiente do termo `stolen_bases`.
