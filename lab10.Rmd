...
library(rms) #Para selecionar modelos de regressão
```
...
> Nota: para sermos mais didáticos, decidimos primeiro fazer a seleção reversa do melhor modelo com o critério do p-valor "manualmente". Contudo, existe uma função no R que faz essa seleção de maneira automática: a função `fastbw()`, da biblioteca `rms`. Vamos testar abaixo:
